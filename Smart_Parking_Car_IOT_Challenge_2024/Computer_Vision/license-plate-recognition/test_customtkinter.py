...
# URL của API
OPEN_BARRIER_URL = "http://172.20.10.4/open-barrier.php"
CLOSE_BARRIER_URL = "http://172.20.10.4/close-barrier.php"
...
def calculate_days_parked(license_plate):
    ...
    if result and result[0] and str(result[0]) != '0000-00-00 00:00:00':
        ...
        days_parked = math.ceil((current_time - parking_time).days)+1
        return days_parked
    return 0
# Load model
