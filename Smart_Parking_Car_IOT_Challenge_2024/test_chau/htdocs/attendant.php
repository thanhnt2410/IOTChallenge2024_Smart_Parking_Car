  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
        ...
        <div class="form-group">
          <div class="col-sm-10">
            <input type="text" class="form-control" placeholder="Parking_id" name="parking_id">
          </div>
        </div>
        <div class="form-group">
...
if(isset($_POST['sub'])){
  ...
  $parking_id=mysqli_real_escape_string($con,$_POST['parking_id']);

  if($Fname==''&& $Lname==''&& $mobile_no=='' && $location=='' && $parking_id == ''){
      ...
      echo"<script>window.open('attendant.php','_self')</script>";
		...
		$insert="INSERT INTO `attendant` (`id_attendant`, `Fname`, `Lname`, `mobile_no`, `location`,`username`,`password`, `parking_id`) VALUES (NULL, '$Fname', '$Lname', '$mobile_no', '$location','$username','$password','$parking_id');";
