...
$(".modal-transparent").on('hidden.bs.modal', function () {
  ...
  <div class="form-group">
      ...
      <input type="sdt" class="text ui-widget-content ui-corner-all" id="sdt" name="sdt" placeholder=""  onkeyup="checkPass(); return false;" required>
  </div> 

  <div class="form-group">
      <label for="biensoxe">Driver license plates </label>
      <input type="biensoxe" class="text ui-widget-content ui-corner-all" id="biensoxe" name="biensoxe" placeholder=""  onkeyup="checkPass(); return false;" required>
  </div> 
...
if(mysqli_num_rows($result) > 0)
{
  ...
  while($row = mysqli_fetch_array($result))
  {
    ...
    // {
    //   //return false
    //    echo"<script>alert('wrong user details".$sel.",try again!')</script>";
