...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item"><span class="glyphicon glyphicon-tags"></span> <?=$parking_price; ?></li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> <?=$parking_name; ?></li>
          <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> <?=$parking_location; ?></li>
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> <?=$parking_price; ?> VND Per Slot</li>
          <li class="list-group-item total"  ><div id="total<?=$parking_id; ?>"> <?=$parking_slot; ?> Total cost</div></li>
          
          <li class="list-group-item">
            <div class="input-group">
              <input type="text" class="form-control"  id="hour<?=$parking_id; ?>" placeholder="Number of Slots" aria-describedby="basic-addon2">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">Select this spacesss</button>
      </div>
    </div>
  </div>
</div>
