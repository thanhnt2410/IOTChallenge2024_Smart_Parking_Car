            ...
            <div class="col-md-12">
                <div class="content-panel">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <?php
                            $sel = "SELECT `requests`.`id`, `slots`, `hours`, `cost`, `customer`, `time`, `status`, `name` 
                                    FROM `requests`, `parkings` 
                                    WHERE `parkings`.`id` = `requests`.`parking_id`";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_status = "UPDATE `requests` SET `status`='$new_status' WHERE `id`='$request_id'";
